...
The dataset utilized in this study was collected from Kaggle, named **Video Game Sales with Ratings** by Rush Kirubi from https://www.kaggle.com/datasets/rush4ratio/video-game-sales-with-ratings. To address the missing values, the dataset was imputed using a **Predictive Mean Matching model**.
...
keep_columns <- c("Global_Sales", "Platform", "Game_Age", "Genre", "Critic_Score", "Critic_Count", "User_Count", "Rating")
...
# Show the table
knitr::kable(head(data, 10), caption = "First 10 Rows of Video Game Sales Data Overview")
```

**Total Rows: `r data_row_count`**
...
knitr::kable(head(data, 10),
             caption = "First 10 Rows of Video Game Sales Data Overview")
```